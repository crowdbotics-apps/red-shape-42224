"""
Django settings for red_shape_42224 project.
...
ROOT_URLCONF = 'red_shape_42224.urls'
...
WSGI_APPLICATION = 'red_shape_42224.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_shape_42224 API",
    "DESCRIPTION": "API documentation for red_shape_42224 App",
    "VERSION": "v1",
}
